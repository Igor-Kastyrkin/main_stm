...
enum actions {walkFf, walkBk, turnL, turnR, wait, standStil, telCenter};
...
enum step_dir {forward, backward};
...
bool Leg_fn(robot_leg leg, regimRaboty regim, leg_dir dir, posOfMotors&);
...
void fSendState(StadyWork WorkSt, actions Action,/* RF24&,*/unsigned short/*,posOfMotors&*/);
